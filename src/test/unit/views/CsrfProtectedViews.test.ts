...
const csrfProtectedViews = [
  ...
  'courts/court-accessibility-edit.njk',
  'courts/add-court.njk',
  'courts/court-building-facilities-edit.njk',
  'courts/court-cases-heard-confirm.njk',
  'courts/court-cases-heard.njk',
  'courts/court-counter-service-opening-hours-delete.njk',
  'courts/court-counter-service-opening-hours-edit.njk',
  ...
  'courts/court-general-edit.njk',
  'courts/court-local-authorities.njk',
  'courts/court-professional-information-confirm.njk',
  'courts/court-professional-information.njk',
  'courts/court-single-point-of-entry.njk',
  'courts/court-translation-and-interpretation.njk',
