...
import { CourtPhotoPage } from './court-photo.po';
...
export const pageFixtures = {
  ...
  courtPhotoPage: async ({ determinePage }, use): Promise<void> => {
    const courtPhotoPage = new CourtPhotoPage(determinePage);
    await use(courtPhotoPage);
  },
