...
import { CourtBuildingFacilitiesService, FacilityModel } from '../../services/courts/CourtBuildingFacilitiesService';
...
export default class CourtBuildingFacilitiesController extends BaseController {
  constructor(private readonly buildingFacilitiesService = new CourtBuildingFacilitiesService()) {
    super();
  }
