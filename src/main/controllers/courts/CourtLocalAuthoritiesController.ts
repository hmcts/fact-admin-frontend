...
export default class CourtLocalAuthoritiesController extends BaseController {
  constructor(private readonly localAuthoritiesService = new CourtLocalAuthoritiesService()) {
    super();
  }
