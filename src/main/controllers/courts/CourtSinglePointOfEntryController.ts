...
export default class CourtSinglePointOfEntryController extends BaseController {
  constructor(private readonly singlePointOfEntryService = new CourtSinglePointOfEntryService()) {
    super();
  }
