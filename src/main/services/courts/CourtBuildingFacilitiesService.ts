...
import {
  COURT_BUILDING_FACILITIES_BABY_CHANGING_REQUIRED_MESSAGE, COURT_BUILDING_FACILITIES_PARKING_REQUIRED_MESSAGE,
  COURT_BUILDING_FACILITIES_QUIET_ROOM_REQUIRED_MESSAGE,
  COURT_BUILDING_FACILITIES_WAITING_AREA_CHILDREN_REQUIRED_MESSAGE,
  COURT_BUILDING_FACILITIES_WAITING_AREA_REQUIRED_MESSAGE, COURT_BUILDING_FACILITIES_WIFI_REQUIRED_MESSAGE
